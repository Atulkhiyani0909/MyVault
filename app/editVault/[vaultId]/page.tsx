...
export default function(){
  ...
  async function getData(){
            const res  = await getVault(params.vaultId);
            console.log(res);
            
        setNotes(res.Notes);
        setTitle(res.title);
        setUrl(res.Url)
        setshowpass(res.password)
        }
   ...
   getData();
    ...
    function clipboard() {
     ...
     async function saveToDB(){
            ...
            setLoading(true);
            const res = await editTOVault(title,showpass,Url,Notes,params.vaultId)
            setLoading(false);
            setTitle("");
            setUrl("");
            setNotes("");
    ...
    <div className="bg-gray-900 min-h-screen text-white font-sans p-4 flex items-center justify-center">
        <div className="w-full max-w-lg p-8 space-y-6 bg-gray-800 rounded-xl shadow-2xl border border-gray-700">
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2 text-gray-200 bg-gray-900 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                ...
                <div>
                    ...
                    <div className="relative flex items-center">
                        <input
                            ...
                            className="w-full pl-4 pr-12 py-2 text-gray-200 bg-gray-900 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                            readOnly
                        />
                        <button 
                            onClick={clipboard} 
            ...
            <details className="bg-gray-900/50 border border-gray-700 rounded-lg open:bg-gray-900/80 transition">
                <summary className="cursor-pointer list-none p-4 font-semibold flex justify-between items-center">
            ...
            <div className="flex flex-col sm:flex-row-reverse items-center gap-3 pt-4">
                ...
                <button
                    ...
                    disabled={loading}
                    onClick={saveToDB}
                    className="w-full sm:w-auto flex justify-center items-center px-6 py-2.5 font-bold text-white rounded-md transition-all
                ...
                <button
                    type="button"
                    onClick={reset}
                    className="w-full sm:w-auto px-6 py-2.5 font-bold text-gray-300 bg-gray-700 hover:bg-gray-600 rounded-md transition-all
